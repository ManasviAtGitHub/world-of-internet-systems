...
`bloom.html`, `heap.html`, `lsm-tree.html`, `hash-table.html`, `trie.html`, `skip-list.html`, `counter.html`, `sketch.html`, `b-tree.html`, `eviction.html`, `queue.html` follow the same design system plus the
...
the same pipeline (harness32-41 in the scratchpad follow the harness31 pattern; the toolbox is complete at eleven pieces).
