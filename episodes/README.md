...
`bloom.html`, `heap.html`, `lsm-tree.html`, `hash-table.html`, `trie.html` follow the same design system plus the
...
the same pipeline (harness32-35 in the scratchpad follow the harness31 pattern).
